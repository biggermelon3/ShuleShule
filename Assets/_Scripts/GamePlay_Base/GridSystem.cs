...
public class GridSystem : MonoBehaviour
{
    ...
    public List<Block> SpecialRemove(GameManager.SpecialShapes specialShapes, Block centerblock)
    {
        ...
        if (specialShapes == GameManager.SpecialShapes.Bomb_Shape)
        {
            ...
            AddBlockToRemoveList(blocksToRemove, x + 1, y, z + 1); // 右前方
            AddBlockToRemoveList(blocksToRemove, x + 1, y, z - 1); // 右后方
            AddBlockToRemoveList(blocksToRemove, x - 1, y, z + 1); // 左前方
            AddBlockToRemoveList(blocksToRemove, x - 1, y, z - 1); // 左后方
